...
function draw() {
  ...
  for (var i = 0; i < cfg.lineDotsCount; i++) {
    tt = i / cfg.lineDotsCount;
    xx = lerp(calculateX(cfg.offsetX1, cfg.radius1, cfg.speed1, time - cfg.delay * tt), calculateX(cfg.offsetX2, cfg.radius2, cfg.speed2, time - cfg.delay * (1 - tt)), tt);
    yy = lerp(calculateY(cfg.offsetY1, cfg.radius1, cfg.speed1, time - cfg.delay * tt), calculateY(cfg.offsetY2, cfg.radius2, cfg.speed2, time - cfg.delay * (1 - tt)), tt);
